...
// B 고정 바의 빠른 메뉴 — 와이어프레임 "My Sony에서 할 수 있는 일!". 페이지 안 앵커
const QUICK_MENU = [
  { href: "#order-tit", label: "주문/배송 조회" },
  { href: "#mysony-tit", label: "정품등록/관리" },
  { href: "#care-tit", label: "연장서비스 플랜 EPS" },
  { href: "#care-tit", label: "픽업서비스 신청/내역" },
